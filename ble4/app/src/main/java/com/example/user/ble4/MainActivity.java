        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            switch (callbackType) {
                ...
                case REQ_CODE_SPEECH_INPUT:
                    ...
                    if (result.getDevice().getName() == result1) {

                        result1 = data1.getStringExtra(RecognizerIntent.EXTRA_RESULTS);
        ...
        switch (requestCode) {
            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    result1 = data.getStringExtra(RecognizerIntent.EXTRA_RESULTS);
